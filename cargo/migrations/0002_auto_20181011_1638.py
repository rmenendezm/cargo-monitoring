# Generated by Django 2.1.2 on 2018-10-11 16:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cell', phonenumber_field.modelfields.PhoneNumberField(blank=True, help_text='Enter the person contact number (e.g. +19999999999, etc.)', max_length=128)),
        ...
        migrations.AddField(
            model_name='employee',
            name='person',
            field=models.ForeignKey(help_text='Select the person this employee represents', on_delete=django.db.models.deletion.PROTECT, to='cargo.Person'),
        ),
        migrations.AddField(
            model_name='employee',
            name='role',
            field=models.ManyToManyField(help_text='Select the roles this employee have in the company', to='cargo.EmployeeRole'),
        ),
        migrations.AddField(
            model_name='cargo',
            name='broker',
        ...
        migrations.AddField(
            model_name='cargo',
            name='dispatcher',
            field=models.ForeignKey(help_text='Represents the employee from a carrier company who close the deal with the broker', on_delete=django.db.models.deletion.PROTECT, related_name='dispatcher', to='cargo.Employee'),
        ),
        migrations.AddField(
            model_name='cargo',
            name='driver',
            field=models.ForeignKey(help_text='Represents the employee from a carrier company who was assigned for delivering the cargo', on_delete=django.db.models.deletion.PROTECT, related_name='driver', to='cargo.Employee'),
        ),
    ]
